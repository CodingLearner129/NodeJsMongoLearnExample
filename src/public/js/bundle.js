      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 7:
          ...
          if (_context.t0.response) {
            if (Object.keys(_context.t0.response).length > 0) {
              (0, _alert.showAlert)('error', _context.t0.response.data.message);
            } else {
              (0, _alert.showAlert)('error', _context.t0.response);
            }
          } else {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          url = type === 'password' ? "/api/v1/auth/update-password" : "/api/v1/users/update-profile";
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam9uYXNzY2htZWR0bWFubiIsImEi0iJjam54ZmM5N3gwNjAzM3dtZDNxYTVlMnd2In0.ytpI7V7w7cyT1Kq5rT9Z1A';
...
var updateProfileForm = document.querySelector('.form-user-data');
...
if (updateProfileForm) {
  updateProfileForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSettings.updateSettings)(form, 'profile');
  });
}
